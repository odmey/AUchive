...
window.addEventListener("DOMContentLoaded", function () {
    ...
    if (likeChapterBtn && typeof CURRENT_CHAPTER_ID !== 'undefined' && CURRENT_CHAPTER_ID > 0) {
        likeChapterBtn.addEventListener("click", async function () {
            ...
            try {
                const response = await fetch("src/Chapter/PHP/like_chapter_action.php", {
                    method: "POST",
...
async function saveProgress(storyId, chapterId, progressPct) {
    ...
    try {
        const response = await fetch("src/Chapter/PHP/save_progress.php", {
            method: "POST",
            headers: {
...
async function postComment() {
    ...
    try {
        const response = await fetch("src/Comment/PHP/post_comment.php", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
async function loadComments() {
    ...
    try {
        const response = await fetch("src/Comment/PHP/get_comments.php?chapter_id=" + CURRENT_CHAPTER_ID);
