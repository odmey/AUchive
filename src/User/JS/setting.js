document.addEventListener("DOMContentLoaded", function () {
    ...
    async function openMenuPopup(type) {
        ...
        if (["account", "email"].includes(type)) {
            try {
                const res = await fetch("src/User/PHP/settings_get_profile.php");
        ...
        if (type === "account") {
            ...
            document.getElementById('btnSaveAccount').addEventListener('click', async () => {
                ...
                try {
                    const res = await fetch("src/User/PHP/settings_update_account.php", { method: 'POST', body: fd });
            ...
            document.getElementById('btnDeleteAccount').addEventListener('click', async () => {
                ...
                if (confirmed) {
                    ...
                    try {
                        const res = await fetch("src/User/PHP/settings_delete_account.php", { method: 'POST', body: fd });
                        const result = await res.json();
                        alert(result.message);
            ...
            document.getElementById('btnSaveEmail').addEventListener('click', async () => {
                ...
                try {
                    const res = await fetch("src/User/PHP/settings_update_email.php", { method: 'POST', body: fd });
                    const result = await res.json();
                    alert(result.message);
                    if (result.success) closeMenuPopup();
                } catch (e) {
            ...
            document.getElementById('btnSavePassword').addEventListener('click', async () => {
                ...
                try {
                    const res = await fetch("src/User/PHP/settings_update_password.php", { method: 'POST', body: fd });
                    const result = await res.json();
                    alert(result.message);
                    if (result.success) closeMenuPopup();
                } catch (e) {
            ...
            if (confirmBtn) {
                confirmBtn.addEventListener("click", async function () {
                    ...
                    try {
                        const res = await fetch("src/User/PHP/logout.php", {
                            method: "POST",
