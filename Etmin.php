...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Bitter&family=Lora&family=Poppins:wght@300;400;500;600;700&display=swap" rel="stylesheet">
      ...
      <div class="data-box">
        <div class="controls-row">
          <div class="search-wrap">
            ...
            <input type="text" id="user-search-input" class="search-input" placeholder="Search users by name, username, or email...">
          </div>
        </div>
    ...
    <section id="stories" class="tab-content">
      <div class="data-box">
        <div class="controls-row">
          <div class="search-wrap">
            <span class="material-symbols-outlined">search</span>
            <input type="text" id="story-search-input" class="search-input" placeholder="Search stories by title or author username...">
          </div>
    ...
    <section id="reports" class="tab-content">
      <div class="data-box">
        <div class="tab-pill-row">
          <button class="tab-pill active" id="pill-pending" data-status="pending">Pending (<span id="count-pending">0</span>)</button>
          <button class="tab-pill" id="pill-resolved" data-status="resolved">Resolved (<span id="count-resolved">0</span>)</button>
          <button class="tab-pill" id="pill-dismissed" data-status="dismissed">Dismissed (<span id="count-dismissed">0</span>)</button>
        </div>
    ...
    <div class="modal-card">
      ...
      <div class="modal-body">
        ...
        <div style="margin-bottom: 15px;">
          ...
          <p id="report-view-desc" style="margin-top: 5px; padding: 12px; background: rgba(255,255,255,0.03); border-radius:8px; border:1px solid var(--border-color);"></p>
        </div>
        <div>
      ...
      <div class="modal-footer">
        <button class="btn-secondary" id="report-dismiss-btn" style="border-color: var(--danger); color: var(--danger);">Dismiss Report</button>
        <button class="btn-primary" id="report-resolve-btn" style="background: var(--success); border-color: var(--success); color: white;">Resolve Report</button>
      </div>
    </div>
  </div>
