...
document.addEventListener("DOMContentLoaded", function () {
  ...
  async function loadDashboard() {
    ...
    const data = await apiFetch("PHP/admin_get_stats.php");
  ...
  async function loadUsers() {
    ...
    const data = await apiFetch(`PHP/admin_get_users.php?${params}`);
    if (!data || !data.success) return;
  ...
  async function loadStories() {
    ...
    const data = await apiFetch(`PHP/admin_get_stories.php?${params}`);
    if (!data || !data.success) return;
  ...
  async function loadReports() {
    ...
    const data = await apiFetch(`PHP/admin_get_reports.php?${params}`);
    if (!data || !data.success) return;
  ...
  async function loadAnalytics() {
    const data = await apiFetch("PHP/admin_get_analytics.php");
    if (!data || !data.success) return;
